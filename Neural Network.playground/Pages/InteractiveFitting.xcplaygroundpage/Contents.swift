...
/*:
 ...
 Try plotting a few points by tapping the white area. Once you have a few points plotted, hit train a few times to see how the network "learns" how to fit those points. As you add points, the amount of training needed will increase.
